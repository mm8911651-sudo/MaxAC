...
import space.max.penalty.handlers.AlertHandler;
import space.max.penalty.handlers.BanHandler;
import space.max.penalty.handlers.KickHandler;
import space.max.penalty.handlers.RawHandler;
...
public class PenaltyExecutor {
    ...
    public PenaltyExecutor(JavaPlugin plugin, AlertManager alertManager) {
        this.plugin = plugin;
        this.logger = plugin.getLogger();
        this.parser = new ActionParser();
        this.placeholders = new PlaceholderProcessor();
        this.handlers = new EnumMap<>(ActionType.class);
        this.alertHandler = new AlertHandler(plugin, alertManager);
