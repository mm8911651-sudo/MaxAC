...
import space.max.penalty.PenaltyExecutor;
...
public class ViolationManager {
    ...
    public ViolationManager(Main plugin, Config config, AlertManager alertManager) {
        ...
        this.penaltyExecutor = new PenaltyExecutor(plugin, alertManager);
    ...
    private void updatePenaltyExecutorConfig() {
        penaltyExecutor.setAlertPrefix(config.getAlertPrefix());
